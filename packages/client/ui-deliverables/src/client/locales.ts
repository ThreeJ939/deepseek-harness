...
export const zh = {
  ...
  'presented.file': '文件',
  'archived.download': '下载',
  'archived.downloadButton': '下载 {name}',
  'archived.file': '文件',
  'archived.bytes': '{bytes} 字节',
  'archived.downloading': '正在准备下载…',
  'archived.success': '已开始下载',
  'archived.error': '下载失败，点击重试',
  'row.title': '交付文件',
  'row.running': '正在交付',
  'row.ok': '已交付',
  'row.error': '交付失败',
...
export const en: Record<DeliverablesKey, string> = {
  ...
  'presented.file': 'File',
  'archived.download': 'Download',
  'archived.downloadButton': 'Download {name}',
  'archived.file': 'File',
  'archived.bytes': '{bytes} bytes',
  'archived.downloading': 'Preparing download…',
  'archived.success': 'Download started',
  'archived.error': 'Download failed. Click to retry.',
