...
export const zh = {
  ...
  'image.unsupportedType': '仅支持 PNG、JPG、WebP、GIF、BMP 格式的图片',
  'document.unsupportedType': '仅支持 PDF、Word、Excel、PPT、文本、JSON、Markdown、CSV、Java、SQL、EPUB 文档',
  'document.pending': '文档',
  'document.remove': '移除 {name}',
  'document.pick': '上传文档',
  'document.tooMany': '一条消息最多添加 {count} 个文档',
  'document.fileTooLarge': '单个文档不能超过 {size}',
  'document.totalTooLarge': '文档总大小不能超过 {size}',
  'document.extractionFailed': '无法从该文档提取文本，请换一份可复制文字的文件后再试',
  'document.sendFailed': '文档发送失败（{reason}），请重新添加文档后再试',
...
export const en = {
  ...
  'image.unsupportedType': 'Only PNG, JPG, WebP, GIF, and BMP images are supported',
  'document.unsupportedType': 'Only PDF, Word, Excel, PPT, text, JSON, Markdown, CSV, Java, SQL, and EPUB documents are supported',
  'document.pending': 'Document',
  'document.remove': 'Remove {name}',
  'document.pick': 'Upload document',
  ...
  'document.totalTooLarge': 'Documents in one message must total less than {size}',
  'document.extractionFailed': 'Could not extract text from that document; try a file with selectable text',
  'document.sendFailed': 'Sending documents failed ({reason}); re-add them and try again',
