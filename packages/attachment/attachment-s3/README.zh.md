...
兼容 S3 的内容寻址附件存储。图片准入与提供者无关的规范化复用 [`dsh-attachment-local`](../attachment-local/README.zh.md)；只有持久对象介质是远端（MinIO 或 AWS S3）。对象键保持 `v1/objects/<sha256[0:2]>/<sha256>`。[`dsh-platform`](../../bundle/platform/README.zh.md) 覆盖层通过 `S3_*` 环境变量挂载本包。
