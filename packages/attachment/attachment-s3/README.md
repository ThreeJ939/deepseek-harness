...
S3-compatible content-addressed attachment store. Image admission and provider-independent normalization reuse [`dsh-attachment-local`](../attachment-local/README.md); only the durable object medium is remote (MinIO or AWS S3). Object keys stay `v1/objects/<sha256[0:2]>/<sha256>`. The [`dsh-platform`](../../bundle/platform/README.md) overlay mounts this package with `S3_*` environment variables.
