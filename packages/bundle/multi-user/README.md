...
No invariant companion is published because the default-Workspace provisioner is request-scoped and has no durable event/data relationship to cross-check; auth and path-policy plugins own their own relations.
