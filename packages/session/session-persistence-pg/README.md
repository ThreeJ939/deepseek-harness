...
No invariant companion is published because PostgreSQL durability and ownership are observable only through backend round-trip tests; this package exposes no continuously observable in-process relation.
